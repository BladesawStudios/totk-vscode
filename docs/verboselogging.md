...
## TKVSC now outputs verbose logs about setup, and file processing to the Output/TKVSC tab.

Click "Terminal" at the top of VSC, then "New Terminal", and switch the tab at the top of the new terminal to "Output", and then click the dropdown and select "TKVSC" to view the logs.
